...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $enabled = array();
    foreach($wizard->configs['extras'] as $setting => $values)
    {
        $_SESSION['extras'][$setting]['url'] = $_POST[$setting];
    }
...
?>
    <div class="panel panel-info">
        <div class="panel-heading"><?php echo PATHS_EXTRAS_TITLE; ?></div>
        <div class="panel-body">
        <div class="form-group">
            <?php 
            foreach($wizard->configs['extras'] as $setting => $default)
            {?>
