...
--
-- Table structure for table `whois_realms`
--

DROP TABLE IF EXISTS `whois_realms`;
...
--
-- Dumping data for table `whois_realms`
--

LOCK TABLES `whois_realms` WRITE;
/*!40000 ALTER TABLE `whois_realms` DISABLE KEYS */;
/*!40000 ALTER TABLE `whois_realms` ENABLE KEYS */;
UNLOCK TABLES;
