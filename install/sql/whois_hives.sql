...
--
-- Table structure for table `whois_hives`
--

DROP TABLE IF EXISTS `whois_hives`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `whois_hives` (
...
--
-- Dumping data for table `whois_hives`
--

LOCK TABLES `whois_hives` WRITE;
/*!40000 ALTER TABLE `whois_hives` DISABLE KEYS */;
/*!40000 ALTER TABLE `whois_hives` ENABLE KEYS */;
UNLOCK TABLES;
