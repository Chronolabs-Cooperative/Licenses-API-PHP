...
CREATE TABLE `sightings` (
  ...
  `segments` int(8) NOT NULL DEFAULT '6',
  `lengths` int(8) NOT NULL DEFAULT '6',
  ...
  `revoked` int(8) NOT NULL DEFAULT '0',
  `regraded` int(8) NOT NULL DEFAULT '0',
  `recovery` int(8) NOT NULL DEFAULT '0',
  `rejections` int(8) NOT NULL DEFAULT '0',
  `created` int(13) NOT NULL DEFAULT '0',
  `accessed` int(13) NOT NULL DEFAULT '0',
  `rejected` int(13) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
