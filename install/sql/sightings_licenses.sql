...
--
-- Table structure for table `sightings_licenses`
--

DROP TABLE IF EXISTS `sightings_licenses`;
...
--
-- Dumping data for table `sightings_licenses`
--

LOCK TABLES `sightings_licenses` WRITE;
/*!40000 ALTER TABLE `sightings_licenses` DISABLE KEYS */;
/*!40000 ALTER TABLE `sightings_licenses` ENABLE KEYS */;
UNLOCK TABLES;
