...
--
-- Table structure for table `netbios`
--
...
--
-- Dumping data for table `netbios`
--

LOCK TABLES `netbios` WRITE;
/*!40000 ALTER TABLE `netbios` DISABLE KEYS */;
/*!40000 ALTER TABLE `netbios` ENABLE KEYS */;
UNLOCK TABLES;
