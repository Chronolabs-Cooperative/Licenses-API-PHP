...
--
-- Table structure for table `whois_emails`
--

DROP TABLE IF EXISTS `whois_emails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `whois_emails` (
...
--
-- Dumping data for table `whois_emails`
--

LOCK TABLES `whois_emails` WRITE;
/*!40000 ALTER TABLE `whois_emails` DISABLE KEYS */;
/*!40000 ALTER TABLE `whois_emails` ENABLE KEYS */;
UNLOCK TABLES;
