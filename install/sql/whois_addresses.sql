...
--
-- Table structure for table `whois_addresses`
--

DROP TABLE IF EXISTS `whois_addresses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `whois_addresses` (
...
--
-- Dumping data for table `whois_addresses`
--

LOCK TABLES `whois_addresses` WRITE;
/*!40000 ALTER TABLE `whois_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `whois_addresses` ENABLE KEYS */;
UNLOCK TABLES;
